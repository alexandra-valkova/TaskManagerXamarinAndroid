...
namespace TaskManagerApiWCF.Models
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="LogworkModel", Namespace="http://schemas.datacontract.org/2004/07/TaskManagerApiWCF.Models")]
    public partial class LogworkModel : TaskManagerApiWCF.Models.BaseModel
    {
    ...
    //[System.Runtime.Serialization.KnownTypeAttribute(typeof(TaskManagerApiWCF.Models.LogworkModel))]
...
[System.ServiceModel.ServiceContractAttribute(ConfigurationName="IBaseServicesOf_LogworkModel")]
public interface IBaseServicesOf_LogworkModel
{
    
    [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/IBaseServicesOf_LogworkModel/GetAll", ReplyAction="http://tempuri.org/IBaseServicesOf_LogworkModel/GetAllResponse")]
    System.IAsyncResult BeginGetAll(System.AsyncCallback callback, object asyncState);
    
    TaskManagerApiWCF.Models.LogworkModel[] EndGetAll(System.IAsyncResult result);
    
    [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/IBaseServicesOf_LogworkModel/GetByID", ReplyAction="http://tempuri.org/IBaseServicesOf_LogworkModel/GetByIDResponse")]
    System.IAsyncResult BeginGetByID(int id, System.AsyncCallback callback, object asyncState);
    
    TaskManagerApiWCF.Models.LogworkModel EndGetByID(System.IAsyncResult result);
    
    [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/IBaseServicesOf_LogworkModel/Save", ReplyAction="http://tempuri.org/IBaseServicesOf_LogworkModel/SaveResponse")]
    System.IAsyncResult BeginSave(TaskManagerApiWCF.Models.LogworkModel entity, System.AsyncCallback callback, object asyncState);
    
    void EndSave(System.IAsyncResult result);
    
    [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/IBaseServicesOf_LogworkModel/Delete", ReplyAction="http://tempuri.org/IBaseServicesOf_LogworkModel/DeleteResponse")]
    System.IAsyncResult BeginDelete(TaskManagerApiWCF.Models.LogworkModel entity, System.AsyncCallback callback, object asyncState);
    
    void EndDelete(System.IAsyncResult result);
}

[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
public interface IBaseServicesOf_LogworkModelChannel : IBaseServicesOf_LogworkModel, System.ServiceModel.IClientChannel
{
}

[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
public partial class GetAllLogworksCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
{
    
    private object[] results;
    
    public GetAllLogworksCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
            base(exception, cancelled, userState)
    {
        this.results = results;
    }
    
    public TaskManagerApiWCF.Models.LogworkModel[] Result
    {
        get
        {
            base.RaiseExceptionIfNecessary();
            return ((TaskManagerApiWCF.Models.LogworkModel[])(this.results[0]));
        }
    }
}
...
[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
public partial class GetLogworkByIDCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
{
    
    private object[] results;
    
    public GetLogworkByIDCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
            base(exception, cancelled, userState)
    {
        this.results = results;
    }
...
[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
public partial class BaseServicesOf_LogworkModelClient : System.ServiceModel.ClientBase<IBaseServicesOf_LogworkModel>, IBaseServicesOf_LogworkModel
{
    ...
    public BaseServicesOf_LogworkModelClient()
    {
    }
    
    public BaseServicesOf_LogworkModelClient(string endpointConfigurationName) : 
            base(endpointConfigurationName)
    {
    }
    
    public BaseServicesOf_LogworkModelClient(string endpointConfigurationName, string remoteAddress) : 
            base(endpointConfigurationName, remoteAddress)
    {
    }
    
    public BaseServicesOf_LogworkModelClient(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) : 
            base(endpointConfigurationName, remoteAddress)
    {
    }
    
    public BaseServicesOf_LogworkModelClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
    ...
    public event System.EventHandler<GetAllLogworksCompletedEventArgs> GetAllCompleted;
    
    public event System.EventHandler<GetLogworkByIDCompletedEventArgs> GetByIDCompleted;
    ...
    System.IAsyncResult IBaseServicesOf_LogworkModel.BeginGetAll(System.AsyncCallback callback, object asyncState)
    {
        return base.Channel.BeginGetAll(callback, asyncState);
    }
    
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    TaskManagerApiWCF.Models.LogworkModel[] IBaseServicesOf_LogworkModel.EndGetAll(System.IAsyncResult result)
    {
    ...
    {
        return ((IBaseServicesOf_LogworkModel)(this)).BeginGetAll(callback, asyncState);
    }
    
    private object[] OnEndGetAll(System.IAsyncResult result)
    {
        TaskManagerApiWCF.Models.LogworkModel[] retVal = ((IBaseServicesOf_LogworkModel)(this)).EndGetAll(result);
        return new object[] {
                retVal};
    }
    ...
    private void OnGetAllCompleted(object state)
    {
        if ((this.GetAllCompleted != null))
        {
            ...
            this.GetAllCompleted(this, new GetAllLogworksCompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState));
        }
    }
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    System.IAsyncResult IBaseServicesOf_LogworkModel.BeginGetByID(int id, System.AsyncCallback callback, object asyncState)
    {
        return base.Channel.BeginGetByID(id, callback, asyncState);
    }
    
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    TaskManagerApiWCF.Models.LogworkModel IBaseServicesOf_LogworkModel.EndGetByID(System.IAsyncResult result)
    {
    ...
    private System.IAsyncResult OnBeginGetByID(object[] inValues, System.AsyncCallback callback, object asyncState)
    {
        ...
        return ((IBaseServicesOf_LogworkModel)(this)).BeginGetByID(id, callback, asyncState);
    }
    ...
    private void OnGetByIDCompleted(object state)
    {
        ...
        {
            InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
            this.GetByIDCompleted(this, new GetLogworkByIDCompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState));
        }
    }
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    System.IAsyncResult IBaseServicesOf_LogworkModel.BeginSave(TaskManagerApiWCF.Models.LogworkModel entity, System.AsyncCallback callback, object asyncState)
    {
        return base.Channel.BeginSave(entity, callback, asyncState);
    }
    
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    void IBaseServicesOf_LogworkModel.EndSave(System.IAsyncResult result)
    {
    ...
    private System.IAsyncResult OnBeginSave(object[] inValues, System.AsyncCallback callback, object asyncState)
    {
        ...
        return ((IBaseServicesOf_LogworkModel)(this)).BeginSave(entity, callback, asyncState);
    }
    
    private object[] OnEndSave(System.IAsyncResult result)
    {
        ((IBaseServicesOf_LogworkModel)(this)).EndSave(result);
        return null;
    }
    ...
    public void SaveAsync(TaskManagerApiWCF.Models.LogworkModel entity)
    {
        this.SaveAsync(entity, null);
    }
    
    public void SaveAsync(TaskManagerApiWCF.Models.LogworkModel entity, object userState)
    {
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    void IBaseServicesOf_LogworkModel.EndDelete(System.IAsyncResult result)
    {
    ...
    {
        ((IBaseServicesOf_LogworkModel)(this)).EndDelete(result);
        return null;
    }
    ...
    protected override IBaseServicesOf_LogworkModel CreateChannel()
    {
        return new BaseServicesOf_LogworkModelClientChannel(this);
    }
    
    private class BaseServicesOf_LogworkModelClientChannel : ChannelBase<IBaseServicesOf_LogworkModel>, IBaseServicesOf_LogworkModel
    {
        
        public BaseServicesOf_LogworkModelClientChannel(System.ServiceModel.ClientBase<IBaseServicesOf_LogworkModel> client) : 
                base(client)
        {
        }
        ...
        public TaskManagerApiWCF.Models.LogworkModel[] EndGetAll(System.IAsyncResult result)
        {
            object[] _args = new object[0];
            TaskManagerApiWCF.Models.LogworkModel[] _result = ((TaskManagerApiWCF.Models.LogworkModel[])(base.EndInvoke("GetAll", _args, result)));
            return _result;
        }
        ...
        public System.IAsyncResult BeginSave(TaskManagerApiWCF.Models.LogworkModel entity, System.AsyncCallback callback, object asyncState)
        {
            object[] _args = new object[1];
            _args[0] = entity;
